...
{
    [SerializeField] private float mass = 1.682645f; // Reduced mass for polygon collider
    [SerializeField] private float accelerationRate = 13.46116f; // Reduced acceleration for reduced mass
